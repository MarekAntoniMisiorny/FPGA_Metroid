...
`default_nettype none
  ...
  wire [10:0] l0_level_w ;
  wire [10:0] l0_level_h ;
  wire [10:0] l1_level_w ;
  wire [10:0] l1_level_h ;

  wire [7:0]  l0_count   ;
  wire [7:0]  l1_count   ;

  wire [MAX_PLATFORMS*11-1:0] l0_x ;
  wire [MAX_PLATFORMS*11-1:0] l0_y ;
  wire [MAX_PLATFORMS*11-1:0] l0_w ;
  wire [MAX_PLATFORMS*11-1:0] l0_h ;

  wire [MAX_PLATFORMS*11-1:0] l1_x ;
  wire [MAX_PLATFORMS*11-1:0] l1_y ;
  wire [MAX_PLATFORMS*11-1:0] l1_w ;
  wire [MAX_PLATFORMS*11-1:0] l1_h ;

  wire [7:0]  l0_dcount ;
  wire [7:0]  l1_dcount ;

  wire [MAX_DOORS*11-1:0] l0_dx ;
  wire [MAX_DOORS*11-1:0] l0_dy ;
  wire [MAX_DOORS*11-1:0] l0_dw ;
  wire [MAX_DOORS*11-1:0] l0_dh ;

  wire [MAX_DOORS*11-1:0] l1_dx ;
  wire [MAX_DOORS*11-1:0] l1_dy ;
  wire [MAX_DOORS*11-1:0] l1_dw ;
  wire [MAX_DOORS*11-1:0] l1_dh ;

  wire [MAX_DOORS*4-1:0]  l0_dtl ;
  wire [MAX_DOORS*4-1:0]  l1_dtl ;
