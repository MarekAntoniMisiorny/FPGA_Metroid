...
(
    ...
    function [10:0] world_to_screen_x;
        input [10:0] obj_x;
        input [10:0] cam_x;
        begin
            if (obj_x >= cam_x)
                world_to_screen_x = obj_x - cam_x;
            else
                world_to_screen_x = 11'd2047;
        end
    endfunction
    ...
    assign floor_screen_x  = world_to_screen_x(FLOOR_X,  CAMERA_X);
    assign plat0_screen_x  = world_to_screen_x(PLAT0_X,  CAMERA_X);
    assign plat1_screen_x  = world_to_screen_x(PLAT1_X,  CAMERA_X);
    assign player_screen_x = world_to_screen_x(PLAYER_X, CAMERA_X);
